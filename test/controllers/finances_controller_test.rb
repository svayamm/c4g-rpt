...
class FinancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create finance" do
    assert_difference('Finance.count') do
      post finances_url, params: { finance: { interest_rate: @finance.interest_rate, outstanding_loan: @finance.outstanding_loan } }
    end
  ...
  test "should update finance" do
    patch finance_url(@finance), params: { finance: { interest_rate: @finance.interest_rate, outstanding_loan: @finance.outstanding_loan } }
